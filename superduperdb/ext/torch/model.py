...
from superduperdb.component.encoder import Encodable
from superduperdb.component.metric import Metric
from superduperdb.component.model import Model, _TrainingConfiguration
...
class TorchModel(Base, Model):  # type: ignore[misc]
    ...
    def train_forward(self, X, y=None):
        """
        This method allows users to define different logic in training
        than in evaluation/ prediction. For example, in training, we may
        want to add augmentations to the data, or other
        sources of random-ness.
