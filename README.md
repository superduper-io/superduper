...
|--------------------------|--------------------------|
| - **MongoDB** <br> - **MongoDB Atlas** <br> - **S3** <br> - *Experimental:* PostgreSQL <br> - *Experimental:* SQLite <br> - *Experimental:* DuckDB <br> - *Experimental:* MySQL <br> - *Experimental:* BigQuery <br> - *Experimental:* Snowflake | - **PyTorch** <br> - **HuggingFace**<br> - **OpenAI**<br> - **Scikit-Learn**<br> - **Llama 2**<br> - **CLIP**<br> - *(Coming soon)* TensorFlow |
