...
class ArtifactStore(ABC):
    ...
    @abstractmethod
    def _delete_bytes(self, r: t.Dict):
        """
    ...
    def exists(self, file_id: t.Optional[str] = None, datatype: t.Optional[str] = None, uri: t.Optional[str] = None):
        if file_id is None:
    ...
    @abstractmethod
    def _load_bytes(self, file_id: str, directory: str) -> bytes:
        """
