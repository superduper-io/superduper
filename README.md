...
- **[Vector Search](https://docs.superduperdb.com/docs/docs/fundamentals/vector_search_algorithm):** No need for duplicating and migrating your data to additional specialized vector databases - turn your existing battle-tested datastore into a fully-fledged multi-modal vector-search database, including easy generation of vector embeddings and vector indexes of your data with preferred models and APIs.
