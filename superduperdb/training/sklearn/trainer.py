...
class SklearnTrainerConfiguration(TrainerConfiguration):
    ...
    def __call__(
        ...
        train_query_params = database._format_fold_to_query(
            query_params, 'train'
        )
        valid_query_params = database._format_fold_to_query(
            query_params, 'valid'
        )
...
class SklearnTrainer:
    ...
    def __call__(self):
        ...
        score = self.models[0].score(
            self.X_valid, self.y_valid, **self.predict_params
        )
